                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="ajout.php">Nos produits</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li>
                                        <button class="button button5"><a href="login.html">Log out</a></button>
                                    </li>
                                </ul>
                            </div>
                        </nav>
...
<tr>
                ...
                <th>Pets :</th> <td><?PHP echo $row['pets']; ?></td>
                    ...
                    <a href="husky.jpg" class="single_gallery_part">
                       <img src="husky.jpg" alt="">
                        <i class="ti-plus"></i>
...
<th>Prix :</th> <td><?PHP echo $row['prix']; ?></td>
    ...
    <input type="submit" name="supprimer" value="supprimer panier">
    <input type="hidden" value="<?PHP echo $row['idP']; ?>" name="idP">
    <td><a href="ajout.php?idP=<?PHP echo $row['idP']; ?>">
Passer Commande</a></td>
    </form>
